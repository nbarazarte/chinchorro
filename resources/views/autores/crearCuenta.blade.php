...
@include('menu')
			...
			<section id="middle">
				...
				<header id="page-header">
					<h1>Crear Autor iLernus</h1>
					<ol class="breadcrumb">
						<li><a href="{{ route('home')}}">Dashboard</a></li>
						<li class="active">Crear Autor iLernus</li>
					</ol>
				</header>
				<!-- /page title -->
								...
								{!! Form::open(['route' => 'registrarAu', 'id' => 'demo-form', '', 'enctype'=>'multipart/form-data', 'class' => 'sky-form boxed ', 'data-success' => 'Se ha creado el Autor con éxito','data-toastr-position' => 'top-right']) !!} 										
													...
													<div class="form-group">
														...
														<div class="col-md-6 col-sm-6">
															...
															<label class="input">
																...
																<span class="tooltip tooltip-top-right">Ingrese el nombre del Autor</span>
															</label>
														</div>
														<div class="col-md-6 col-sm-6">
															<label>Sexo *</label>
															...
															<select name="str_genero" class="form-control pointer required">
																...
																<span class="tooltip tooltip-top-right">seleccione el género del Autor</span>
															</label>
														</div>
													</div>
												</div>
													...
													<div class="form-group">
														<div class="col-md-6 col-sm-6">
															...
															<label class="input">
																...
																<span class="tooltip tooltip-top-right">Ingrese la profesión del Autor</span>
															</label>
														</div>
														<div class="col-md-6 col-sm-6">
															<label>
											...
											<div class="row">
												<div class="col-md-12">
													...
													{!! Form::submit('CREAR AUTOR', ['class' => 'btn btn-3d btn-teal btn-xlg btn-block margin-top-30']) !!}
