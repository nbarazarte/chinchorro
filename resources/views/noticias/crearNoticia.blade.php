														...
														<div class="col-md-6 col-sm-6">
															...
															<label class="input margin-bottom-10">
											 					...
											 					<select id="str_tipo" name="str_tipo" class="form-control required" onchange="showfieldTipo(this.options[this.selectedIndex].value)">
											 						...
											 						<!--<option value="simple">Noticia Simple</option>-->
											 						<option value="imagen">Noticia con sólo una imágen</option>
											 						<option value="carrusel-imagen">Noticia con carrusel de imagenes</option>
											 						<option value="video">Noticia con video</option>
											 						<option value="audio">Noticia con audio</option>
											 					</select>
